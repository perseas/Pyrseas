...
"""
    ...
    Note(Devoted): This was pulled into a separate package
    (https://github.com/perseas/pgdbconn) and I pulled it back in to help
    simplify dependencies. pgdbconn was pulling inycopg rather than
    psycopg-binary which meant that we needed psql client to be installed.
"""
import sys
